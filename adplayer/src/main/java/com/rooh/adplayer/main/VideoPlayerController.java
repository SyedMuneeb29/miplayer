                        ...
                        public void onAdEvent(AdEvent adEvent) {
                            ...
                            switch (adEvent.getType()) {
                                ...
                                case LOADED:
                                    ...
                                    if (adsControllerCallback != null ) {
                                        adsControllerCallback.onAdsLoaded();
                                    }
...
//                                        resumeContent();
                                    ...
                                    if (adsControllerCallback != null ) {
                                        adsControllerCallback.onVideoContentResumeReqeusted();
                                    }
                                ...
                                case PAUSED:
                                    ...
                                    if (adsControllerCallback != null ) {
                                        adsControllerCallback.onAdsPaused();
                                    }
                                    break;
                                case RESUMED:
...
//                                    }
            ...
            adsRenderingSettings.setLoadVideoTimeout(55000);
...
//      adsRenderingSettings.setEnablePreloading(true);
     ...
     * just a URL and could trigger additionaAl decisions regarding ad tag selection.
     */
