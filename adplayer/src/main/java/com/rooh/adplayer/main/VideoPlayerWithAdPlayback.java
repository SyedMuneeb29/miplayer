...
import com.rooh.adplayer.R;
import com.rooh.adplayer.samplevideoplayer.SampleVideoPlayer;
import com.rooh.adplayer.samplevideoplayer.VideoPlayer;
...
class VideoPlayerWithAdPlayback extends RelativeLayout {
    ...
    private void onVolumeClick () {
        ...
        if (isMute) {
            ...
            volumeButton.setBackground(getResources().getDrawable(R.drawable.volume_up_foreground));
...
//
        videoPlayer = new SampleVideoPlayer(getContext()) ;
        ...
        videoPlayer.layoutParams(videoLayout) ;

        adUiContainer = new RelativeLayout(getContext()) ;
        RelativeLayout.LayoutParams uiLayout = new RelativeLayout.LayoutParams(
                LayoutParams.MATCH_PARENT ,
                videoLayout.MATCH_PARENT
        ) ;
        uiLayout.addRule(RelativeLayout.CENTER_HORIZONTAL);
